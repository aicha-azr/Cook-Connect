        ...
        <div className="container mx-auto px-4 mt-20">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0 text-orange">
              ...
              <p className="text-white text-xl mb-8 p-1 font-BodyFont">
      ...
      <section className="py-20 bg-blanc" id="about">
        <div className="lg:px-96 md:px-20">
          ...
          <p className="p-4 text-2xl text-md sm:text-left sm:text-1xl md:text-left md:text-1xl  font-sans overflow-hidden  font-BodyFont text-black-maron ">
            ...
            treasures from every corner of the planet, delivered straight to
            your doorstep. Through a blend of history, flavors, and traditions,
            we invite you on a captivating gastronomic journey, where each dish
            tells a story, each recipe shares a tradition, and each bite opens a
            window into a different culture. Whether you're a seasoned culinary
            explorer or a novice eager to learn, our site is designed to
            inspire, educate, and connect you through the universal magic of
            food. Explore our articles rich with anecdotes about iconic dishes,
            discover authentic recipes passed down through generations, learn
            unique culinary techniques from each region, and immerse yourself in
            the fascinating narratives that surround each plate. Join our
            vibrant community of passionate foodies, share your own culinary
            stories, exchange tips and recipes with people from around the
            world, and get ready to embark on an unforgettable journey through
            the cuisines of the world. Prepare to awaken your taste buds,
            broaden your culinary horizons, and discover a multitude of
            gastronomic delights that celebrate the richness and diversity of
            our world. Welcome to our global kitchen. Welcome home.
          </p>
        </div>
      </section>
      <section id="contact">
        <div className="pb-10 bg-blanc w-[100%] h-[100%]" data-aos="zoom-in-up">
          <div className="grid  font-BodyFont sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-bleu-ciel shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
            <div>
              <h1 className="text-3xl text-orange font-HeadingFont font-bold">
                Let's Talk
              </h1>
              ...
              <div className="mt-12">
                <h2 className="text-lg text-black-maron font-HeadingFont font-bold">
                  Email
                </h2>
                <ul className="mt-3">
                  <li className="flex items-center">
                    ...
                    <a
                      ...
                      className="text-[#291f1d] text-sm ml-3"
                    >
            ...
            <form className="ml-auo space-y-4">
              ...
              <textarea
                placeholder="Message"
                rows="6"
                className="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#007bff] bg-blanc"
              ></textarea>
              <button
                type="button"
                className="text-black-maron bg-jaune hover:bg-black-maron hover:text-blanc font-semibold rounded-md text-sm px-4 py-2.5 w-full"
              >
                Send
              </button>
            </form>
